...
const CACHE = 'mesada-v19';
const ASSETS = [
  './', './index.html', './manifest.json',
  './assets/styles.css', './assets/icon.svg',
  './assets/fonts/archivo-latin.woff2', './assets/fonts/archivo-italic-latin.woff2',
  './assets/js/icons.js', './assets/js/photos.js', './assets/js/effects.js', './assets/js/store.js', './assets/js/ui.js', './assets/js/agenda.js', './assets/js/pet.js', './assets/js/bank.js', './assets/js/quiz.js', './assets/js/usage.js', './assets/js/dash.js', './assets/js/notify.js', './assets/js/wordbank.js', './assets/js/wordgames.js', './assets/js/games.js', './assets/js/screen-auth.js',
